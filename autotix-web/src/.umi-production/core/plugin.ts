...
import * as Plugin_0 from '/Users/norman/development/autotix/autotix-web/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/norman/development/autotix/autotix-web/src/app.tsx',
    },
    {
      apply: Plugin_1,
